...
public class CorpsInGroupPlotFragment extends Fragment {

    private static final Logger LOG = LoggerFactory.getLogger(CorpsInGroupPlotFragment.class);
    private static String GROUP_ID = "groupId";

    public static final CorpsInGroupPlotFragment newInstance(String groupId) {

        CorpsInGroupPlotFragment f = new CorpsInGroupPlotFragment();
        f.groupId = groupId;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup vg = (ViewGroup) inflater.inflate(
                R.layout.corps_in_group_compare_plot_fragment, container, false);


        // initialize our XYPlot reference:
        plot = (XYPlot) vg.findViewById(R.id.plot);
